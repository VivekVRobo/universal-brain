...
class EventType(str, Enum):
    ...
    # Canonical operator action lifecycle projections
    ACTION_PROPOSED = "ACTION_PROPOSED"
    ACTION_STATE_CHANGED = "ACTION_STATE_CHANGED"

    # Canonical ephemeral-worker job lifecycle projections
    WORKER_JOB_ENQUEUED = "WORKER_JOB_ENQUEUED"
    ...
    WORKER_JOB_REQUEUED = "WORKER_JOB_REQUEUED"
